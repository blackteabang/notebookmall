          ...
          <div className="container" style={{ maxWidth: '800px' }}>
            ...
            <div className="home-hero-buttons">
              ...
              <button className="btn-secondary" style={{ 
                ...
                <span style={{ fontSize: '0.9rem', fontWeight: 800, letterSpacing: '0.05em' }}>PARTNER APPLICATION</span>
                <span style={{ fontSize: '0.75rem', fontWeight: 500, opacity: 0.9 }}>파트너신청</span>
              </button>
            </div>
          </div>
        </section>
